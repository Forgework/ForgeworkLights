...
if command -v kitty &> /dev/null; then
    kitty --class="forgework-lights-tui" --title="ForgeworkLights" -e /usr/local/bin/omarchy-argb-menu
elif command -v alacritty &> /dev/null; then
    alacritty --class="forgework-lights-tui" --title="ForgeworkLights" -e /usr/local/bin/omarchy-argb-menu
