...
if command -v ghostty &> /dev/null; then
    ...
    kitty --class="forgework-lights-tui" --title="ForgeworkLights" -o initial_window_width=80c -o initial_window_height=57c -e /usr/local/bin/omarchy-argb-menu
elif command -v alacritty &> /dev/null; then
    alacritty --class="forgework-lights-tui" --title="ForgeworkLights" -o window.dimensions.columns=80 -o window.dimensions.lines=57 -e /usr/local/bin/omarchy-argb-menu
    ...
    xterm -class forgework-lights-tui -title ForgeworkLights -geometry 80x57 -e /usr/local/bin/omarchy-argb-menu
else
    # Fallback
